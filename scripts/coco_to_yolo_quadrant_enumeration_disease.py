...
def convert_coco_to_yolo():
    coco_json_path = os.path.join(os.path.dirname(__file__), 'train_quadrant_enumeration_disease.json')
    ...
    # 处理有categories_3的情况，默认用categories_3（疾病分类）
    if 'categories_3' in coco_data:
