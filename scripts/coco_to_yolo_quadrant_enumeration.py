...
def convert_coco_to_yolo():
    coco_json_path = os.path.join(os.path.dirname(__file__), 'train_quadrant_enumeration.json')
    ...
    # 处理有categories_1和categories_2的情况，默认用categories_1
    if 'categories_1' in coco_data:
